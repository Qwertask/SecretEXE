...
func uploadHandler(w http.ResponseWriter, r *http.Request) {
	...
	// Внесение изменений в exe файл (пример: замена текста)
	...
	timestampURL := "http://timestamp.digicert.com" // Замените на действительный URL сервера меток времени
...
func uploadHandlerMain(w http.ResponseWriter, r *http.Request) {
...
func uploadHandlerEDS(w http.ResponseWriter, r *http.Request) {
	w.Header().Set("Content-Type", "text/html; charset=utf-8")
...
func uploadHandlerEDS_CHECK(w http.ResponseWriter, r *http.Request) {
